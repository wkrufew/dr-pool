    ...
    'menu' => [
       ...
       /*  [
        ...
        [
            ...
            'icon_color' => 'yellow',
            'active' => ['admin/contacs*'],
        ],
        [
            'text' => 'Approved Requests',
            'route' => 'admin.contacts.aprobada',
            'icon_color' => 'cyan',
            'icon' => 'far fa-fw fa-address-card',
            'active' => ['admin/contacs/aprobada'],
        ],
        [
            'text' => 'Rejected Requests',
            'route' => 'admin.contacts.rechazo',
            'icon_color' => 'red',
            'icon' => 'far fa-fw fa-address-card',
            'active' => ['admin/contacs/rechazo'],
        ],
        ['header' => 'General'],
