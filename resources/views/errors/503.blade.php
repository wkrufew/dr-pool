...
@section('message', __('Estamos en mantenimiento pilas')) --}}
<style>
    html,
    body {
        margin: 0 auto;
...
<main>
    <h2 style="color: #1e3a8a; margin-bottom: 15px; font-size: 80px">Dr. Pools</h2>
   <div class="logo" style="color: #1e3a8a; margin-bottom: 15px;">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 68">
        <g id="large">
            <path fill="none" stroke="#1e3a8a"
    ...
    <h1 style="color: #1e3a8a; margin-top: 20px;">Under Maintanance</h1>
    <h2 style="color: #777c8d">Sorry for the inconvenience.</h2>
    <h3 style="color: #777c8d">To contact us in the meantime please email:</h3>
    <a href="mailto:doc@dr-pools.com" style="color: #1e3a8a">doc@dr-pools.com</a>
</main>
<footer>Dr. Pools</footer>
