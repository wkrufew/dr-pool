...
<div class="card">
    <div class="card-header">
        <a class="btn btn-primary" href="{{route('admin.brands.create')}}">New Product</a>
    </div>
            ...
            <table class="table table-striped table-hover table-sm text-center">
                <thead class="thead-dark ">
                    <tr>
                        <th>#</th>
                        <th>Name</th>
                        <th class="tostada">Link</th>
                        <th class="tostada">Logo</th>
                ...
                <tbody>
                    @forelse ($brands as $key=>$brand)
                        <tr class="items-center justify-center">
                            ...
                            <td><img style="border-radius: 50%" src="{{Storage::url($brand->foto)}}" height="40px;" width="40px;" alt=""></td>
                           
                            <td width="10px">
                                <a class="btn btn-primary btn-sm" href="{{route('admin.brands.edit', $brand)}}"><i class="fas fa-edit"></i></a>
                            </td>
                            <td width="10px">
                                <form class="formulario_eliminar" action="{{route('admin.brands.destroy', $brand)}}" method="POST">
                                    @method('delete')
                                    @csrf
                    ...
                    @empty
                        <tr>
                            <td colspan="5">No hay ningun producto registrado</td>
                        </tr>
...
<script>
    ...
    $('.formulario_eliminar').submit(function (e) {
        ...
        Swal.fire({
            ...
            text: "The brans will be permanently removed",
            icon: 'warning',
