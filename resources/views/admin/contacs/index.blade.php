...
@section('content_header')
    <h1>Pending contacts to be assigned to a service</h1>
@stop
            ...
            <form action="{{ route('admin.contacts.index') }}" method="GET">
                ...
                <div class="form-row">
                    <div class="col-sm-4 my-1">
                        <input type="text" class="form-control" name="texto" placeholder="Search a contact ...">
                    </div>
                    <div>
                    ...
                    @forelse ($contacts as $key=>$contact)
                        <tr>
                            ...
                            <td class="flex justify-center">
                                <form action="{{ route('admin.contacts.aprobar', $contact) }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 btn btn-sm btn-success"><i
                                            class="fas fa-check-square mr-2"></i>To Assign </button>
                                </form>
                            </td>
                            <td>
                            ...
                            <td class="flex justify-center">
                                <form action="{{ route('admin.contacts.rechazar', $contact) }}" method="POST">
                                    @csrf
                                    <button title="Rechazar" type="submit"
                                        class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 btn btn-sm btn-danger"><i
