...
<x-guest-layout>
    ...
    {{-- <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-6 bg-blue-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img class="w-16 md:w-44 hidden md:block" src="{{ asset('img/home/FONDO TRANSPARENTE.png') }}" alt="">
                    </div>
                    
                    <a class="text-3xl text-blue-800 font-display text-center xl:text-5xl tracking-wide font-semibold" href="{{route('home')}}">Dr. Pools</a>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-3xl text-blue-700 font-display font-semibold lg:text-left xl:text-4xl
                ...
                <div class="mt-12">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-blue-700 tracking-wide ml-4">Correo</div>
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-bold text-blue-700 tracking-wide ml-4">
                                    Contraseña
                                </div>
                        ...
                        <div class="mt-10">
                            <button class="bg-blue-500 text-gray-50 p-4 w-full rounded-full tracking-wide
                            font-semibold font-display focus:outline-none text-md focus:shadow-outline hover:bg-blue-600
                            shadow-xl">
                                Iniciar
                            </button>
                        </div>
        ...
        <div class="hidden lg:flex items-center justify-center bg-blue-300 flex-1 h-screen">
