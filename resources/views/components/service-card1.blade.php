...
<article class="bg-white shadow-lg rounded-lg overflow-hidden border-4 border-white hover:shadow-xl hover:border-blue-400 relative">
        ...
        <div class="flex">
            ...
            <div class="ml-4 cursor-pointer">
                {{-- <a href="{{route('coverage')}}"> --}}
                    <img width="25px" src="{{Storage::url($service->logo)}}" alt="">
                {{-- </a> --}}
            </div>
        </div>
