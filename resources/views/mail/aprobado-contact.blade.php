...
<body>
    ...
    <h1 class="titulopro">“Welcome Aboard”</h1>
    <p>
        Your information has been processed successfully, 
        The family of Dr.Pools thanks you for choosing us.
    </p>
    ...
    <div>
        <p>
            ...
            <br>
            <b>Request date:</b> {{$contact->created_at}}
            <br>
            <b>Approval date:</b> {{$contact->updated_at}}
