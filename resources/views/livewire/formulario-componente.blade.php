<div>
        ...
        <div class="relative w-full mb-4 mt-2">
            <label for="" class="block uppercase text-blue-900 text-xs font-bold mb-2">Service selected </label>
            <p class="text-gray-600 border-2 border-gray-100 px-3 py-2 placeholder-blueGray-300 text-blueGray-600 bg-white rounded-full text-sm shadow-md focus:outline-none focus:ring w-full"><b>{{$service->title}}</b> </p>
        ...
        <div class="relative w-full mb-1 mt-2">
            ...
            <p class="block text-gray-600 text-xs mb-2">Select at least one photo of the pool</p>       
            <input  wire:model="file1" type="file" accept="image/png, .jpeg, .jpg"  cols="30" rows="2" class="text-gray-700 border-2 mb-2 border-gray-100 px-3 py-2 placeholder-blueGray-300  bg-white rounded-xl text-sm shadow-md focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
